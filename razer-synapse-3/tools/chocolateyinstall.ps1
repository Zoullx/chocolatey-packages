...
$RazerSynapseDependenciesSetupPackageArgs = @{
  ...
  checksum      = 'F21BFD1C50DB5E9A6E4CFA43CDBB2E768BCD0C1779EAF9F61826EF0B7729D968'
  checksumType  = 'sha256'
...
$RazerCentralPackageArgs = @{
  ...
  fileType      = 'EXE'
  url           = $RazerCentralUrl
  checksum      = 'C04F456450178B55A67EF3993AC4BD146A471A675F35677A2337024E48B0F5D8'
  checksumType  = 'sha256'
...
$GMSSetupPackageArgs = @{
  ...
  fileType      = 'EXE'
  url           = $GMSSetupUrl
  checksum      = 'C14A80E9A3F08723FE76AED4AA0921E0970DEF69462A837EE9FF62F8B83FB0D3'
  checksumType  = 'sha256'
...
$RazerStringTranslationsSetupPackageArgs = @{
  ...
  checksum      = '7024550DC39B3D1BCFA73503FFB3377D34F252DC0968CAF97FBA830EEEF6D831'
  checksumType  = 'sha256'
  silentArgs    = '/S /LWIDIR="C:\Program Files (x86)\Razer" /ISLASTMODULE=False'
  validExitCodes= @(0, 3010, 1641)
}
...
$RazerSynapseConfigurationDataSetupPackageArgs = @{
  ...
  checksum      = '0B26EAD7EDB9A8250AD6513353E2E4591E66FEBCAE58D25F2C3D92A477B71CD7'
  checksumType  = 'sha256'
  silentArgs    = '/S /LWIDIR="C:\Program Files (x86)\Razer" /ISLASTMODULE=False'
  validExitCodes= @(0, 3010, 1641)
}
...
$RazerSynapseSetupPackageArgs = @{
  ...
  checksum      = 'D2F968AC1965A95D9AE705EB7C0456EC2B18729C634C63B9B830C929D0FFCFB3'
  checksumType  = 'sha256'
