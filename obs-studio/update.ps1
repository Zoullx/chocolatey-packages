...
$downloadUrl = 'https://api.github.com/repos/obsproject/obs-studio/releases/latest'
...
function global:au_GetLatest {
  ...
  $asset = $response.assets | Where-Object { $_.name -match "OBS-Studio-(?<Version>.*)-Windows-x64-Installer.exe" } | Select-Object -First 1
